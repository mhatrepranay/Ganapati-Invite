...
const Schedule = ({ language }) => {
    ...
    const eventsMr = [
        ...
        { time: "२ सप्टेंबर – संध्याकाळी ४ वा.", title: "आरती (संध्याकाळची आरती)", icon: "🪔" },
